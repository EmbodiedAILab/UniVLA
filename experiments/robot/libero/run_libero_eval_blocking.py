                ...
                try:
                    ...
                    if len(action_queue) == 0:
                        ...
                        latent_action, visual_embed, generated_ids = get_latent_action(
                            ...
                            task_description,
                            processor=processor,
                            hist_action='',         # NOTE: not compatible with history latent action input
                        )
                        ...
                        # Get action chunk
                        action_queue.extend(action_decoder(latent_action, visual_embed, mask, action_low, action_high))
                    
                    # Get single-step action from action chunk
